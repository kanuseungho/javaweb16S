...
<body>
  ...
  <p class="text-center">
	...
	<br/>
	<div class="text-center">
	  <button class="btn btn-outline-warning" onClick="order()">주문하기</button> &nbsp;
	  <button class="btn btn-outline-warning" onClick="location.href='${ctp}/myPage/customer/memberInquire2';">배송정책알아보기</button>
	  <button class="btn btn-outline-warning" onClick="history.back()">돌아가기</button>
	</div>
</div>
   <p><br/></p>
